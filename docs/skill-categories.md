...
| --- | ---: |
| Categorias | 12 |
| Skills no manifesto | 1210 |
| Skills instaláveis | 1205 |
...
| <span style="color:#0ea5e9">&#9679;</span> **Backend, APIs e Arquitetura** | `backend-architecture` | 55 | 55 | Skills para APIs, Laravel, bancos, autenticação, arquitetura, padrões backend e integrações complexas. |
